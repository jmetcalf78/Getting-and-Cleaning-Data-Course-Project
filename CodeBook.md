...
This project required the student to use data contained within the Human Activity Recognition Using Smartphones Data Set.  Extensive background on that data set follows. For details on how the data was used specifcally for this project, please refer to the README.md file uploaded to my github site:
...
## Human Activity Recognition Using Smartphones Data Set - Feature Selection 
